...
addressForm :: forall ui. Monoid ui => Form ui Address Address
addressForm = ado 
...
personForm :: forall ui. Monoid ui => Form ui Person Person
personForm = ado 
...
passwordForm :: forall ui r. Monoid ui => Form ui { password :: String, passwordConfirmation :: String | r }  String
